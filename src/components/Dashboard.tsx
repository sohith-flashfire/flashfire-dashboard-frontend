          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              ...
              <div className="text-center mb-12">
                  ...
                  <p className="text-xl lg:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-light">
                      Track your job applications, monitor your progress, and
                      optimize your career journey with AI-powered insights.
                  </p>
              </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                      {[
                          ...
                          },
                          {
                              ...
                              label: "Interviewing",
                              count: userJobs?.filter(
                                  (item) => item.currentStatus == "interviewing"
                              ).length,
                              color: "bg-amber-500",
                              icon: Users,
                          },
                  ...
                  {recentJobs.length > 0 ? (
                      ...
                      <div className="text-center py-12">
                          ...
                          <p className="text-gray-600 mb-6">
                              Start by adding your first job application to see
                              your progress here.
                          </p>
